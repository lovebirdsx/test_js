...
class RenderRegistry {
    ...
    regRender<TData, TMeta extends IMeta = IMeta, TParent = unknown, TScheme extends IScheme<TData, TMeta, TParent> = IScheme<TData, TMeta, TParent>>(renderType: string, render: Render<TData, TMeta, TParent, TScheme>) {
