...
function createBaseISimple(): ISimple {
  return {
    Name: "",
    Age: 0,
    state: 0,
...
export const ISimple = {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ISimple {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseISimple();
  ...
  toJSON(message: ISimple): unknown {
    const obj: any = {};
  ...
  fromPartial<I extends Exact<DeepPartial<ISimple>, I>>(object: I): ISimple {
    const message = createBaseISimple();
